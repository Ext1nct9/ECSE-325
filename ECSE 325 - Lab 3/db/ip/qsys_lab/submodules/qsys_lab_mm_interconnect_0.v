...
module qsys_lab_mm_interconnect_0 (
	...
	wire  [113:0] leds_s1_agent_rp_data;                                    // LEDS_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [113:0] switches_s1_agent_rp_data;                                // SWITCHES_s1_agent:rp_data -> router_003:sink_data
	...
	wire          pushbuttons_s1_agent_rp_valid;                            // PUSHBUTTONS_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] pushbuttons_s1_agent_rp_data;                             // PUSHBUTTONS_s1_agent:rp_data -> router_004:sink_data
	wire          pushbuttons_s1_agent_rp_ready;                            // router_004:sink_ready -> PUSHBUTTONS_s1_agent:rp_ready
	wire          pushbuttons_s1_agent_rp_startofpacket;                    // PUSHBUTTONS_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          pushbuttons_s1_agent_rp_endofpacket;                      // PUSHBUTTONS_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> LEDS_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // LEDS_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> LEDS_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> SWITCHES_s1_burst_adapter:sink0_data
	...
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> PUSHBUTTONS_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> PUSHBUTTONS_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // PUSHBUTTONS_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> PUSHBUTTONS_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> PUSHBUTTONS_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> PUSHBUTTONS_s1_burst_adapter:sink0_endofpacket
	...
	wire    [2:0] pushbuttons_s1_burst_adapter_source0_channel;             // PUSHBUTTONS_s1_burst_adapter:source0_channel -> PUSHBUTTONS_s1_agent:cp_channel
	...
	wire          pushbuttons_s1_agent_rdata_fifo_out_valid;                // PUSHBUTTONS_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pushbuttons_s1_agent_rdata_fifo_out_data;                 // PUSHBUTTONS_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          pushbuttons_s1_agent_rdata_fifo_out_ready;                // avalon_st_adapter_002:in_0_ready -> PUSHBUTTONS_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                        // avalon_st_adapter_002:out_0_valid -> PUSHBUTTONS_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                         // avalon_st_adapter_002:out_0_data -> PUSHBUTTONS_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                        // PUSHBUTTONS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                        // avalon_st_adapter_002:out_0_error -> PUSHBUTTONS_s1_agent:rdata_fifo_sink_error
	...
	qsys_lab_mm_interconnect_0_router_002 router_003 (
	...
	qsys_lab_mm_interconnect_0_router_002 router_004 (
	...
	qsys_lab_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (LEDS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (LEDS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (LEDS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (LEDS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
